...
{
    public class UpdateSubcomponentValidator : AbstractValidator<UpdateSubcomponentDto>
    {
        public UpdateSubcomponentValidator()
        {
            RuleFor(s => s.Id)
                .GreaterThan(0).WithMessage("Subcomponent ID must be greater than 0.");
